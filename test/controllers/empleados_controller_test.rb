...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { apellido: @empleado.apellido, nombre: @empleado.nombre, puesto: @empleado.puesto, rfc: @empleado.rfc, sucursal_id: @empleado.sucursal_id, usuario_id: @empleado.usuario_id } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { apellido: @empleado.apellido, nombre: @empleado.nombre, puesto: @empleado.puesto, rfc: @empleado.rfc, sucursal_id: @empleado.sucursal_id, usuario_id: @empleado.usuario_id } }
